...
public:
	...
	//2. sprawdza dostępność salda (karta.get_saldo) (jesli nie ma podaje saldo i prosi o podanie innej kwoty)
	//2* sprawdza dostępność gotowki w bankomacie
	...
	void wyplac();
	bool odczyt();  // bool - żeby sprawdził czy dana karta istnieje
	void zapis();
